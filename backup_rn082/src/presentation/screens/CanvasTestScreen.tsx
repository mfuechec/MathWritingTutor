  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.version}>React Native 0.82 + React 19</Text>
      </View>
      ...
      <View style={styles.metrics}>
        ...
        <View style={styles.metricRow}>
          ...
          <Text style={styles.metricValue}>
            {lastStrokeTime > 0
              ? new Date(lastStrokeTime).toLocaleTimeString()
              : 'N/A'}
          </Text>
        </View>
      </View>
      ...
      <View style={styles.statusContainer}>
        ...
        <Text style={styles.statusItem}>✓ React Native 0.82.1</Text>
        <Text style={styles.statusItem}>✓ React 19.1.1</Text>
        <Text style={styles.statusItem}>✓ Skia GPU rendering active</Text>
        <Text style={styles.statusItem}>✓ Gesture handler configured</Text>
        <Text style={styles.statusItem}>✓ Modern Gesture.Pan() API</Text>
      </View>
    </ScrollView>
  );
};
